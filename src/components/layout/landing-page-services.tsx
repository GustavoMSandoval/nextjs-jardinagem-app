...
export default function LandingPageServices() {
  return (
    ...
    <ServiceCardComponent imageBottomDirection imageRightDirection  style="bg-[#f5f2f0] " linkImg="/images/jardins.png" title="serviços" text="Oferecemos total assistência na manutenção e reformulação de jardins já existentes, garantindo que o elemento paisagístico seja mantido belo e exuberante em sua plenitude." buttonText="conheça nossos serviços"/>
    <ServiceCardComponent imageBottomDirection linkImg="/images/images_cards/paisagismo-jardinagem-jardinsecia6.jpg" title="manutenção" text="Executamos manutenção de jardim periódica:" description="mensal,
